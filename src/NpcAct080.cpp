...
void ActNpc096(NPCHAR *npc)
{
	...
	switch (npc->act_no)
	{
		...
		case 2:
			...
			if (gMC.routine == ROUTINE_CONTROL && gMC.y < npc->y + 0x1000 && gMC.y > npc->y - 0x1000 && gMC.x < npc->x && gMC.x > npc->x - 0xC000)
			{
				gMC.xm -= 0x88;
				gMC.cond |= 0x20;
			}
...
void ActNpc097(NPCHAR *npc)
{
	...
	switch (npc->act_no)
	{
		...
		case 2:
			...
			if (gMC.routine == ROUTINE_CONTROL && gMC.x < npc->x + 0x1000 && gMC.x > npc->x - 0x1000 && gMC.y < npc->y && gMC.y > npc->y - 0xC000)
			{
				gMC.ym -= 0x88;
...
void ActNpc098(NPCHAR *npc)
{
	...
	switch (npc->act_no)
	{
		...
		case 2:
			...
			if (gMC.routine == ROUTINE_CONTROL && gMC.y < npc->y + 0x1000 && gMC.y > npc->y - 0x1000 && gMC.x < npc->x + 0xC000 && gMC.x > npc->x)
			{
				gMC.xm += 0x88;
				gMC.cond |= 0x20;
			}
...
void ActNpc099(NPCHAR *npc)
{
	...
	switch (npc->act_no)
	{
		...
		case 2:
			...
			if (gMC.routine == ROUTINE_CONTROL && gMC.x < npc->x + 0x1000 && gMC.x > npc->x - 0x1000 && gMC.y < npc->y + 0xC000 && gMC.y > npc->y)
				gMC.ym += 0x88;
