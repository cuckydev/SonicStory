...
void ActNpc150(NPCHAR *npc)
{
	...
	npc->rect.top += 96 * gMIMCurrentNum;
	npc->rect.bottom += 96 * gMIMCurrentNum;

	if (npc->act_no == 21)
	{
		npc->rect.bottom = (npc->act_wait * 3 / 8) + npc->rect.top;
